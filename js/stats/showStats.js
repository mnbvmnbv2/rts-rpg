...
function statsUpdate(){ //i fanen til venstre stats
    if(dead == true){
        ...
        "<br>Type: "                        + typeBoxes(player.type) +                      //type
    ...
    if(sec === 0){ //gjør tiden rød når det blir nytt min
        stats1rightEl.innerHTML =  
        "<font color='#2adb59'>" + globalLevel + "</font> " +
        "<br><font color='gold'>" + gold + "</font> " + 
        "<br>" + encounterNumber + " " + 
        "<br><font color='red'>" + min + ":" + sec + "</font></font>&nbsp"; //gjør tiden rød når det blir nytt min
    } else{
        stats1rightEl.innerHTML =                               //samme som over men talldelen
        "<font color='#2adb59'>" + globalLevel + "</font> " +   //globallvl
...
function enemyStatsUpdate(){ //helt høyre stats
    if(dead === false){
        ...
        "<font color='#FFFFFF'>" + enemy.name + //navnet
        "<br>Type: " + typeBoxes(enemy.type) +  //type
        "<br>Level: " + enemy.level +           //lvl
